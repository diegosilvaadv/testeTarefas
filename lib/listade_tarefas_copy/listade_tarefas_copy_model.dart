...
import 'listade_tarefas_copy_widget.dart' show ListadeTarefasCopyWidget;
...
class ListadeTarefasCopyModel
    extends FlutterFlowModel<ListadeTarefasCopyWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - SQLite (getListaTarefasAll)] action in ListadeTarefasCopy widget.
