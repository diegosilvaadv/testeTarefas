  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetCategoriasRow:
            return GetCategoriasRow(data);
          case GetListaTarefasRow:
            return GetListaTarefasRow(data);
          case GetPerfilUserRow:
            return GetPerfilUserRow(data);
          case GetCategoriasSelecionadaRow:
            return GetCategoriasSelecionadaRow(data);
          case GetCategoriaColorRow:
            return GetCategoriaColorRow(data);
          case GetListaTarefasCopyRow:
            return GetListaTarefasCopyRow(data);
          default:
            return null;
        }
